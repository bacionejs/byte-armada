...
To reduce UI complexity, instead of choosing distinct units with various abilities, you have *two traits*, which, when combined with *five magnitudes*, provide *25 combinations*, with some inverse relationships, hoping that complex strategies *might* emerge. **But in the end, nothing tactically interesting emerged, in fact, PvP is a constant stalemate**.
