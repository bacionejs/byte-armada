...
> **Note:** The handshake code is 3,604 bytes, including 1,069 bytes for the DataMatrix algorithm and an additional 85 bytes for my in-game code, totaling **3,689** bytes for me to support PvP. (zipped sizes)
